void Limit(){
  const int nChannels = nChannels = 4;
 ...
 //ATLAS     doi:10.1016/j.physletb.2016.03.017
  ...
  for(int i = 1; i < (steps + 1); i++) {
    ...
    signal->SetBinError(3,0.2 * signal->GetBinContent(3));
