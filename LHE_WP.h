...
// Sat Jun 25 14:33:31 2016 by ROOT version 5.34/26
// from TTree LHEF/Analysis tree
// found on file: PROC_WEff_UFO_0/Events/run_02/events_2TeV.root
//////////////////////////////////////////////////////////
...
#ifdef LHE_WP_cxx
LHE_WP::LHE_WP(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("events_w.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("events_w.root");
      }
...
Int_t LHE_WP::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t LHE_WP::LoadTree(Long64_t entry)
{
...
void LHE_WP::Show(Long64_t entry)
{
...
Int_t LHE_WP::Cut(Long64_t entry)
{
